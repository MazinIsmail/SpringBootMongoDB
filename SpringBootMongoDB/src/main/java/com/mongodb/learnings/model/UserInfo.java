...
public class UserInfo {
		...
		public String toString() {
			return "UserInfo [id=" + id + ", userId=" + userId + ", userName="
					+ userName + ", userFirstName=" + userFirstName
					+ ", userLastName=" + userLastName + ", userPassword="
					+ userPassword + ", email=" + email + ", defaultHomePage="
					+ defaultHomePage + ", userStatus=" + userStatus
					+ ", userRole=" + userRole + ", lastLogin=" + lastLogin
